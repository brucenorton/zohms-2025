...
<div class="row">
    ...
    <div class="col-md-7">
        <br>
        <h3>Solution parfaite pour les installations audio professionnelles dans :</h3>
    
        <p>Centres commerciaux, hôtels, aéroports, parcs d'attractions, stades, cinémas, salles de réception, bateaux de croisière, centres commerciaux de plein air, hôpitaux, restaurants, entrepôts, universités, parcs aquatiques, bars, etc.</p>
